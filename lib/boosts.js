...
export const BOOSTS = [
  ...
  },
  {
    ...
    blurb: 'Their next bet this week costs double the stake.',
    detail:
      ...
      'go to bet. Cheap because it costs them nothing if they simply stop betting.',
    doublesStake: true,
    attack: true,
  },
  {
    ...
    detail:
      ...
      'worse for them. Blocked by Insurance.',
    flips: true,
    attack: true,
  },
  {
