 ...
 *
 * The earliest game day wins: if ANY player the market depends on has already
 * taken the field, the bet is no longer honest. One Thursday starter closes the
 * whole matchup Wednesday night -- that is the rule, not an edge case.
 *
