...
export const BOOSTS = [
  ...
  // they cannot be bought until that question is settled.
  {
    ...
    family: FAMILY.PAYOUT,
    target: TARGET.BET,
    blurb: "Takes someone else's winning bet for yourself.",
    detail: 'They staked it, you collect it. Blocked by Insurance.',
    attack: true,
    comingSoon: true,
  },
  {
  ...
  },
  {
    ...
    family: FAMILY.PAYOUT,
    target: TARGET.BET,
    blurb: 'Used after the games. Takes a cut of a winning bet.',
    detail:
      'Only available once bets are public, so it reveals nothing -- by then ' +
      'nobody can act on what they see. Pure spite.',
    attack: true,
    comingSoon: true,
  },
];
...
export const PAYOUT_ORDER = ['boost-50', 'boost-week', 'payout-cut'];
