 ...
 * share of game left, projection, status -- so any move can be explained
 ...
 * was written.
 * @param rows  [{ id, price, points, remaining, projection, status }]
 */
 ...
 * [{ t, price, points, remaining, projection, status }]. Rows from before
