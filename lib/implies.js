 ...
 *
 * SIX PARLAYS PLACED BEFORE THIS EXISTED ARE BEING HONOURED. An audit on
 * 2026-09-17 found six of the seven parlays ever placed used the gap, worth
 * about $1,000 of overpayment if every one of them won. Chris chose to let
 * week 2 stand -- nobody knowingly broke a rule that did not exist, and most of
 * them were the innocent shape (a side to win AND to cover). They settle at the
 * odds their slips quoted, from the leg odds already stored on the bet, so this
 * module never touches them. The rule starts with the next parlay placed.
 *
