 ...
 *
 * Set against what the trophies actually pay. It was 7 when a season's trophy
 * haul simulated at about 99 points (scripts/sim-points.mjs), a 50/50 split
 * between showing up and winning things. On 2026-09-14 every trophy value was
 * doubled and the opening balance raised to 50, because 21 points a week
 * against boosts of 15 to 75 and stud shares near 18 bought one thing, never
 * two; 10 keeps the allowance about a third of an average week, the floor
 * rather than the income.
 *
 * The floor: somebody who never wins a trophy still collects 140 across a
 * season, a couple of attacks and a shield. At 5 it was three weeks of saving
 * for anything that bites.
 */
export const WEEKLY_ALLOWANCE = 10;
 ...
 *
 * Priced against the simulation rather than by feel. Before the 2026-09-14
 * doubling a season's income was about 197 points (99 trophy + 7/wk allowance
 * over 14 weeks) against 588 for one of every boost -- three seasons. It is
 * now roughly 340 plus Daily and dividends, so a year buys about half the
 * catalogue. Prices were left alone on purpose: raise them if the shop gets
 * silly, which is easier than lowering them.
 *
...
export const BOOSTS = [
  // ---------- defence ----------
  {
    ...
    detail:
      'Chosen when you place the bet, in the slip -- it cannot be added afterwards. A ' +
    ...
    defensive: true,
    // Called at placement or not at all. Attaching it later, once a bounty has
    // appeared or a bet is going well, turns a guess into a reaction.
    slipOnly: true,
  },

  {
    ...
    detail:
      ...
      'takes the same attack on their own biggest open bet. They are told. A bounty ' +
      'rebounds onto EVERYONE who chipped in. Chosen when you place the bet; it ' +
  ...
  },
  {
    ...
    detail:
      'Nobody can attack what they cannot see. The dearest protection in the shop ' +
  ...
  },
  {
    ...
    detail:
      ...
      'all, it just turns a hit into a grudge. A crowd-funded hit names EVERYONE who ' +
      'chipped in, and how much. A penny, because knowing is its own reward.',
    reveals: true,
  },
  ...
  // ---------- your own upside ----------
  {
    ...
    detail:
      'Chosen when you place the bet -- pick wrong and it pays for nothing. It used to ' +
      'be attachable to a bet that was already going well, which made it a reaction ' +
      'rather than a call; now you have to call it.',
    multiplier: 1.5,
    slipOnly: true,
  },
  {
  ...
  },
  {
    ...
    detail:
      ...
      'pull out. Works on a bet that has been HIT, too: the theft or the void is wasted ' +
      'and the whole stake comes back, which is part of what the price buys. The ' +
      'dearest thing in the shop because it removes the risk entirely. Cash Out is the ' +
      'everyday version: cheaper, settles at the current price, and cannot be used on a ' +
      'bet that has been hit.',
    voids: true,
  },
  {
    kind: 'cash-out',
